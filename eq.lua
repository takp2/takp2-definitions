...
--- Chooses a random item from provided list
function eq.ChooseRandom(...) end

--- Cast spell on calling client
---@param spell_id number # Spell ID
function eq.SelfCast(spell_id) end

--- Returns string representing category of class
---@param class_id number # Class ID to identify
---@return string # Returns hybrid, melee, caster, priest or other
function eq.ClassType(class_id) end

-- random amount of cash in copper, returns totals of copper, silver, gold, platinum
---@param min number # Minimum amount of cash
---@param max number # Maximum amount of cash
---@return number, number, number, number # Returns copper, silver, gold, platinum
function eq.RandomCash(min, max) end
...
---@param arg1? NPC|number
---@param arg2? NPC|Client|number
---@return string[]
---@overload fun(client: Client): string[]
function eq.get_qglobals(arg1, arg2) end
...
--- Signal npc_id with signal_id after wait seconds
---@param npc_id number #
---@param signal_id? number #
---@param wait? number #
---@param data? string #
function eq.signal(npc_id, signal_id, wait, data) end
...
---@param z number #
---@param heading? number #
---@param name? string # Optional name for the mob
---@return Mob # Newly spawned mob
function eq.spawn2(npc_type, grid, unused, x, y, z, heading, name) end
